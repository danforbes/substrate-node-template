...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("bca-node"),
    impl_name: create_runtime_str!("bca-node"),
    authoring_version: 1,
...
impl pallet_bca::Config for Runtime {
    type Event = Event;
}
...
impl_runtime_apis! {
    ...
    impl frame_benchmarking::Benchmark<Block> for Runtime {
        fn dispatch_benchmark(
            ...
            add_benchmark!(params, batches, pallet_bca, Bca);
